...
int monthly_rate(double hourly_rate, double discount) {
  ...
  return std::ceil(daily_rate(discounted_hourly_rate) * 22);
}
...
int days_in_budget(int budget, double hourly_rate, double discount) {
  ...
  auto discounted_hourly_rate = apply_discount(hourly_rate, discount);
  auto discounted_daily_rate = daily_rate(discounted_hourly_rate);
